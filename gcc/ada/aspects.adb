...
package body Aspects is
   ...
   Has_Aspect_Specifications_Flag : constant array (Node_Kind) of Boolean :=
     (N_Action_Declaration                     => True,
      N_Atomic_Type_Declaration                => True,
      ...
      N_Single_Atomic_Declaration              => True,
   ...
   (No_Aspect                           => No_Aspect,
    ...
    Aspect_Budget_Action                => Aspect_Budget_Action,
    ...
    Aspect_Cycle_Period                 => Aspect_Cycle_Period,
    Aspect_Cycle_Phase                  => Aspect_Cycle_Phase,
    Aspect_Deadline_Action              => Aspect_Deadline_Action,
    Aspect_Deadline_Handler             => Aspect_Deadline_Handler,
    ...
    Aspect_No_End_Barrier               => Aspect_No_End_Barrier,
    Aspect_No_Start_Barrier             => Aspect_No_Start_Barrier,
    Aspect_No_Return                    => Aspect_No_Return,
    Aspect_Object_Size                  => Aspect_Object_Size,
    Aspect_Output                       => Aspect_Output,
    Aspect_Pack                         => Aspect_Pack,
    Aspect_Participating_Actions        => Aspect_Participating_Actions,
    ...
    Aspect_Restore_State                => Aspect_Restore_State,
    ...
    Aspect_Timing_Behaviour             => Aspect_Timing_Behaviour,
