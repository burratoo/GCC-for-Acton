...
package Aspects is
   ...
   Aspect_Delay : constant array (Aspect_Id) of Delay_Type :=
     (No_Aspect                           => Always_Delay,
      ...
      Aspect_Cycle_Behaviour              => Always_Delay,
      Aspect_Cycle_Period                 => Always_Delay,
      Aspect_Cycle_Phase                  => Always_Delay,
      Aspect_Deadline_Handler             => Always_Delay,
      Aspect_Deadline_Response            => Always_Delay,
      ...
      Aspect_Execution_Budget             => Always_Delay,
      Aspect_Execution_Server             => Always_Delay,
      Aspect_Execution_Server_Object      => Always_Delay,
