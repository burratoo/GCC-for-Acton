...
package Aspects is
   ...
   Aspect_Names : constant array (Aspect_Id) of Name_Id := (
     ...
     Aspect_CPU                          => Name_CPU,
     Aspect_Cycle_Kind                   => Name_Cycle_Kind,
     ...
     Aspect_No_Start_Barrier             => Name_No_Start_Barrier,
